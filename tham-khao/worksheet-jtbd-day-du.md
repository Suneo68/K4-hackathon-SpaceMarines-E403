...
**Hai chỗ đau nhất trong workflow:** #1 ___________ · #2 ___________
**Bằng chứng ban đầu cho 2 chỗ này** (từ chatlog/Discord/tự quan sát — sẽ đào sâu ở Bước 2): ___________
...
**Core JTBD bản nháp:** ___________
**Từ solution lỡ nhét vào (gạch bỏ):** ___________
**Core JTBD bản chốt:** ___________
...
**Nếu sản phẩm nhóm không ra đời, user sẽ tiếp tục:** ___________
...
**AI nên vào bước nào của workflow, vai trò gì:** ___________
**Vì sao không phải bước khác:** ___________
...
**Assumption nguy hiểm nhất nếu nhóm đang sai** (sẽ kiểm bằng evidence + vòng validation CP5): ___________
